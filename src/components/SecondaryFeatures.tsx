...
const features = [
  {
    ...
    description:
      "Know exactly what you're getting. More specific than any other site.",
    icon: DeviceArrowIcon,
  },
  {
    name: 'Batch Specific Reviews',
    description:
      "Every batch is different. Make sure that you are getting the exact high you're looking for.",
    icon: DeviceCardsIcon,
  },
  {
    name: 'Fast and Simple Reviews',
    description:
      'The quickest and easiest way to review. Period.',
      ...
      <Container>
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-medium tracking-tight text-gray-900">
            Get The Best High Ever.
          </h2>
          <p className="mt-2 text-lg text-gray-600">
            We take the guesswork out of the equation. Leaving you to contemplate the cosmos in peace. 
          </p>
        </div>
        <ul
          role="list"
